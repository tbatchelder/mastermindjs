...
export function InfoPanel({
  ...
  const effectiveSlotMax = settings.duplicates
    ? SLOT_MAX
  ...
  return (
    <>
      ...
      {mobileOpen && (
        <div className="panel-backdrop mobile-only" onClick={onMobileClose} />
      )}

      <div className={`info-panel ${mobileOpen ? "panel-open" : ""}`}>
        {/* Mobile close button */}
        <button
        ...
        <section className="info-section">
          ...
          <ol className="instructions-list">
            <li>Tap or drag a color from the Color panel into a slot.</li>
            <li>
            ...
            <li>
              ...
              <ul>
                ...
                <li>
                  <span className="peg-demo peg-yellow-demo" /> right color,
                  wrong spot
                </li>
              </ul>
            </li>
        ...
        <section className="info-section">
          ...
          <p className="settings-note">
            Changing any setting starts a new game.
          </p>
